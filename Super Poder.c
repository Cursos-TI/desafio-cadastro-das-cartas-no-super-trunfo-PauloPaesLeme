...
int main() {
    ...
    // Super Poder
    float super_poder_c1 = (1 / (densidade_c1 != 0 ? densidade_c1 : 1)) + populacao_c1 + pib_c1 + pib_per_capita_c1 + pontos_c1;
    float super_poder_c2 = (1 / (densidade_c2 != 0 ? densidade_c2 : 1)) + populacao_c2 + pib_c2 + pib_per_capita_c2 + pontos_c2;

    // Comparação
    printf("\n\n===== Comparação =====\n");
    printf("População: %d\n", (populacao_c1 > populacao_c2) ? 1 : 0);
    printf("Área: %d\n", (area_c1 > area_c2) ? 1 : 0);
    printf("PIB: %d\n", (pib_c1 > pib_c2) ? 1 : 0);
    printf("Densidade Populacional: %d\n", (densidade_c1 < densidade_c2) ? 1 : 0);
    printf("PIB per Capita: %d\n", (pib_per_capita_c1 > pib_per_capita_c2) ? 1 : 0);
    printf("Pontos Turísticos: %d\n", (pontos_c1 > pontos_c2) ? 1 : 0);
    printf("Super Poder: %d\n", (super_poder_c1 > super_poder_c2) ? 1 : 0);
